...
import { ChevronDown, Construction, Pencil, Plus, ShieldCheck } from "lucide-react";
...
import type { BackendRole, RoleDefinition } from "@/types";
...
export default function RolesPage() {
  if (!USE_MOCKS) return <LiveRolesPage />;
  return <MockRolesPage />;
}

function LiveRolesPage() {
  return (
    <PageTransition>
      <PageHeader
