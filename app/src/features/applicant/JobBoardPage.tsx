...
export default function JobBoardPage() {
  ...
  return (
    <PageTransition>
      <PageHeader
        title="Job board"
        description="Every open position across E-SHURI schools — teaching and beyond."
      />
                ...
                <Card hover padded={false} className="flex flex-col h-full gap-2.5 p-4">
                  ...
                  {v.subject && (
                    <div className="flex flex-wrap gap-1.5">
                      <Badge variant="success" className="text-[11px]">{v.subject}</Badge>
                    </div>
                  )}
